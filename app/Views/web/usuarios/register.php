            ...
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                ...
                <div class="card shadow-lg my-5" >
                    <div class="card-body p-5">
                        <h1 class="fs-4 card-title fw-bold mb-4 text-center">Registrarse</h1>

                        <?= view("partials/_form-errors") ?>

                        <form method="POST" action="<?= base_url("register_post") ?>" class="needs-validation" novalidate="" autocomplete="off">
                    ...
                    <div class="card-footer py-3 border-0">
                        <div class="text-center">
                            ¿Deseas iniciar sesión? <a href="<?= base_url("login") ?>" class="text-dark">Click aquí!</a>
                        </div>
                    </div>
                </div>
